/**
 * Кнопка буззера: шесть состояний, одно из которых тикает.
 *
 ...
 *   вопрос закрыт — «ОТВЕЧЕНО», серая, заблокирована (по вопросу засчитан «+2»)
 *
...
Quiz.ui.buzzer = {
    ...
    STATES: {
        ...
        // Ответ на текущий вопрос засчитан («+2»): закрыт для всех, пока
        // ведущий не перейдёт на неотвеченный. Решает store.currentQuestionAnswered.
        answered: { text: 'ОТВЕЧЕНО',   css: 'is-taken', disabled: true }
    },
