...
Quiz.ui.players = {
    ...
    actions: function (participant, isAnswering) {
        ...
        // не за что; снимать буззер тоже больше не с кого. В каждой строке
        // они бы только путались с оценкой.
        if (isAnswering) {
            ...
            box.appendChild(this.button('Снять', 'Освободить буззер без оценки', function () {
