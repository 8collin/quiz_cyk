...
Quiz.store = {
     ...
     * по той же причине, что и звуки, и так же переживают её смену.
     *
     * Читает их только панель пользователей и только когда её открыли:
     * в игре они не участвуют, а на табло стоят строки participant.
     */
    users: [],
