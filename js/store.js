...
Quiz.store = {
    ...
    /**
     * Строки profile — люди, у которых есть аккаунт. Игре не принадлежат
     * по той же причине, что и звуки, и так же переживают её смену. Несут и
     * `sound_key` — джингл человека, общий на все игры (см. 007_sound_global).
     *
     * Читают их две местные панели ведущего и только когда открыты: панель
     * пользователей (имя, логин, роль) и панель звуков (раздача джинглов по
     * аккаунтам). В игре профили не участвуют — на табло стоят participant.
     */
    users: [],
