...
Quiz.game = {
     ...
     *
     * Ровно score() плюс то, что делает кнопка «Ответ» в шапке, — это
     * буквально она и есть, а не «показать»: если ответ уже открыт,
     * нажатие его закроет. На своём месте это и не мешает, потому что
     * переход к вопросу сбрасывает show_answer, и к моменту оценки ответ
     * закрыт.
     *
