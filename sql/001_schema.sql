...
-- поставил (-1 / 0 / +1 / +2), чтобы «отвечал, но не получил ничего»
-- осталось видно. Ограничения на значение нет намеренно: набор оценок
-- задаёт панель ведущего, и +2 добавилась в неё, не тронув схему.
-- ---------------------------------------------------------------------
